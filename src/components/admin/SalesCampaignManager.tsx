...
const festivalPresets = [
  ...
  { name: "Republic Day Sale", message: "🇮🇳 Republic Day! Patriotic Savings!", color: "#f97316", theme: "republic_day" },
  { name: "Navratri Sale", message: "💃 Navratri Special! Dance into savings!", color: "#d946ef", theme: "navratri" },
  { name: "Durga Puja Sale", message: "🙏 Durga Puja Blessings! Divine deals!", color: "#dc2626", theme: "durga_puja" },
  ...
  { name: "Makar Sankranti Sale", message: "🪁 Makar Sankranti! Fly high with savings!", color: "#f97316", theme: "makar_sankranti" },
  { name: "Pongal Sale", message: "🌾 Pongal Celebrations! Harvest of deals!", color: "#22c55e", theme: "pongal" },
  { name: "Baisakhi Sale", message: "🌾 Baisakhi Joy! New harvest, new deals!", color: "#eab308", theme: "baisakhi" },
  ...
  { name: "Chinese New Year Sale", message: "🧧 Lunar New Year! Prosperity awaits!", color: "#dc2626", theme: "chinese_new_year" },
  ...
  { name: "Cyber Monday Sale", message: "💻 Cyber Monday! Online exclusive deals!", color: "#3b82f6", theme: "cyber_monday" },
  { name: "St. Patrick's Day Sale", message: "☘️ Lucky Day! Find your pot of gold!", color: "#22c55e", theme: "st_patricks" },
  { name: "Mother's Day Sale", message: "💐 Mother's Day! Gifts of love!", color: "#ec4899", theme: "mothers_day" },
  { name: "Father's Day Sale", message: "👔 Father's Day! Celebrate Dad!", color: "#3b82f6", theme: "fathers_day" },
  { name: "Memorial Day Sale", message: "🇺🇸 Memorial Day! Honor with savings!", color: "#1e40af", theme: "memorial_day" },
  { name: "Labor Day Sale", message: "👷 Labor Day! Work hard, save more!", color: "#dc2626", theme: "labor_day" },
  { name: "Mid-Autumn Festival Sale", message: "🥮 Moon Festival! Mooncake deals!", color: "#f59e0b", theme: "mid_autumn" },
  { name: "Oktoberfest Sale", message: "🍺 Oktoberfest! Prost to savings!", color: "#78350f", theme: "oktoberfest" },
  ...
  { name: "Summer Sale", message: "☀️ Summer Sale! Hot deals, cool prices!", color: "#fbbf24", theme: "summer" },
  { name: "Monsoon Sale", message: "🌧️ Monsoon Sale! Shower of savings!", color: "#0ea5e9", theme: "monsoon" },
  { name: "Winter Sale", message: "❄️ Winter Sale! Warm deals, cold prices!", color: "#64748b", theme: "winter" },
  { name: "Spring Sale", message: "🌸 Spring Sale! Fresh deals blooming!", color: "#f472b6", theme: "spring" },
  { name: "Back to School Sale", message: "📚 Back to School! Smart savings!", color: "#0ea5e9", theme: "back_to_school" },
];
...
const festivalThemes = [
  ...
  { value: "republic_day", label: "🇮🇳 Republic Day - Parade & Pride", icon: "🇮🇳" },
  { value: "navratri", label: "💃 Navratri - Dandiya & Dance", icon: "💃" },
  { value: "durga_puja", label: "🙏 Durga Puja - Divine Blessings", icon: "🙏" },
  { value: "ganesh_chaturthi", label: "🐘 Ganesh Chaturthi - Modak & Prayers", icon: "🐘" },
  { value: "onam", label: "🛶 Onam - Flowers & Boats", icon: "🛶" },
  { value: "raksha_bandhan", label: "🎀 Raksha Bandhan - Rakhis & Gifts", icon: "🎀" },
  { value: "eid", label: "🌙 Eid - Moon & Stars", icon: "🌙" },
  { value: "makar_sankranti", label: "🪁 Makar Sankranti - Kites Flying", icon: "🪁" },
  { value: "pongal", label: "🌾 Pongal - Harvest Festival", icon: "🌾" },
  { value: "baisakhi", label: "🌾 Baisakhi - Harvest Joy", icon: "🌾" },
  
  // Worldwide Festivals
  { value: "christmas", label: "🎄 Christmas - Snow & Santa Walking", icon: "🎄" },
  { value: "new_year", label: "🎆 New Year - Confetti & Fireworks", icon: "🎆" },
  { value: "chinese_new_year", label: "🧧 Chinese New Year - Dragon & Lanterns", icon: "🧧" },
  ...
  { value: "black_friday", label: "🛒 Black Friday - Shopping Frenzy", icon: "🛒" },
  { value: "cyber_monday", label: "💻 Cyber Monday - Digital Deals", icon: "💻" },
  { value: "st_patricks", label: "☘️ St. Patrick's Day - Clovers & Rainbow", icon: "☘️" },
  { value: "mothers_day", label: "💐 Mother's Day - Flowers & Love", icon: "💐" },
  { value: "fathers_day", label: "👔 Father's Day - Ties & Gifts", icon: "👔" },
  { value: "memorial_day", label: "🇺🇸 Memorial Day - Honor & Remembrance", icon: "🇺🇸" },
  { value: "labor_day", label: "👷 Labor Day - Work Celebration", icon: "👷" },
  { value: "mid_autumn", label: "🥮 Mid-Autumn - Mooncakes & Lanterns", icon: "🥮" },
  { value: "oktoberfest", label: "🍺 Oktoberfest - Bavarian Festival", icon: "🍺" },
  
  // Seasonal Themes
  { value: "summer", label: "☀️ Summer - Beach Vibes", icon: "☀️" },
  { value: "monsoon", label: "🌧️ Monsoon - Rainy Days", icon: "🌧️" },
  { value: "winter", label: "❄️ Winter - Snowflakes", icon: "❄️" },
  { value: "spring", label: "🌸 Spring - Cherry Blossoms", icon: "🌸" },
  { value: "back_to_school", label: "📚 Back to School - Academic", icon: "📚" },
];
