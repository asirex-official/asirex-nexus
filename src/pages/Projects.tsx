...
const projects = [
  ...
  },
  {
    ...
    features: ["AI Vision + Sensors", "Smart Docking Stations", "Rescue Bots (2/dock)", "AI Drones (5/dock)", "National Dashboard", "Multi-Pollution Filtration", "Central Intelligence System"],
    progress: 6,
    sections: [
      {
        icon: "⚙️",
